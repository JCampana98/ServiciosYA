...
describe('Service Tests', () => {
  describe('Coordinate Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(CoordinateService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Coordinate(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Coordinate', async () => {
        const returnedFromService = Object.assign(
          {
            latitude: 'BBBBBB',
            longitude: 'BBBBBB'
