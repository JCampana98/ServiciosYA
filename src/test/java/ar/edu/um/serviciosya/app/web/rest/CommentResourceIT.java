...
import ar.edu.um.serviciosya.app.repository.CommentRepository;
import ar.edu.um.serviciosya.app.service.CommentService;
import ar.edu.um.serviciosya.app.service.dto.CommentDTO;
import ar.edu.um.serviciosya.app.service.mapper.CommentMapper;
...
public class CommentResourceIT {
    ...
    private static final Integer DEFAULT_QUALIFICATION = 0;
    private static final Integer UPDATED_QUALIFICATION = 1;
    private static final Integer SMALLER_QUALIFICATION = 0 - 1;
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getQualification()).isEqualTo(DEFAULT_QUALIFICATION);
        assertThat(testComment.getCommentary()).isEqualTo(DEFAULT_COMMENTARY);
    }
    ...
    public void updateComment() throws Exception {
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getQualification()).isEqualTo(UPDATED_QUALIFICATION);
        assertThat(testComment.getCommentary()).isEqualTo(UPDATED_COMMENTARY);
    }
