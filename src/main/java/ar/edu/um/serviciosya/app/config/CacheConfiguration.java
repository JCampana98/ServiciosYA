package ar.edu.um.serviciosya.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ar.edu.um.serviciosya.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ar.edu.um.serviciosya.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
