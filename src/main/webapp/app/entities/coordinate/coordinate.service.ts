...
type EntityResponseType = HttpResponse<ICoordinate>;
type EntityArrayResponseType = HttpResponse<ICoordinate[]>;
...
export class CoordinateService {
  ...
  update(coordinate: ICoordinate): Observable<EntityResponseType> {
    return this.http.put<ICoordinate>(this.resourceUrl, coordinate, { observe: 'response' });
  }
